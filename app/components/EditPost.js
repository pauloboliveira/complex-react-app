...
function EditPost(props) {
    ...
    if (state.isFetching) return <Page title="..."> <LoadingDotIcon /> </Page>
        ...
        <Page title="Edit Post">
            ...
            <form className="mt-3" onSubmit={submitHandler}>
                ...
                <div className="form-group">
                    ...
                    <textarea onBlur={e => dispatch({ type: "bodyRules", value: e.target.value })} name="body" id="post-body" className="body-content tall-textarea form-control" type="text" value={state.body.value} onChange={e => dispatch({ type: "bodyChange", value: e.target.value })} />
